...
def main():
    ...
    semantic = [[1,14,23], [2,4,5,9,13]]

    semantic = {}
    semantic['forward'] = [2,4,5,9,13]
    semantic['backward'] = [1,14,23]

    # for sem_index in range(32):
    for sem_name in semantic.keys():
    # if 1:
        # sem_index = 8
        sem_index = semantic[sem_name]
        ...
        # for curr_epoch in range(6):
            ...
            for i, data in enumerate(tqdm.tqdm(data_loader_train)):
                ...
                if i == 0:
                    # utils.save_image(img_edit.reshape((-1, 3, 256, 704))[:, [2,1,0], ...] / 255, f'semantic_label/img_new/trains_%02d_%04d.jpg' % (sem_index, curr_epoch))
                    ...
                    utils.save_image(img_edit.reshape((-1, 3, 256, 704))[:, [2,1,0], ...] / 255, f'semantic_exp/vis_folder/trains_{sem_name}_%04d.jpg' % (curr_epoch))
                    # import ipdb; ipdb.set_trace()
            ...
            torch.save(patch_net.module.lc_list[0], f'semantic_exp/lc_folder/lc_{sem_name}_%04d.pth' % (curr_epoch))
            ...
            for i, data in enumerate(data_loader):
                with torch.no_grad():
                    ...
                    if i == 0:
                        ...
                        utils.save_image(img_edit.reshape((-1, 3, 256, 704))[:, [2,1,0], ...] / 255, f'semantic_exp/vis_folder/vals_{sem_name}_%04d.jpg' % (curr_epoch))
            ...
            if rank == 0:
                ...
                if args.eval:
                    ...
                    print('current semantic part: ', (sem_name, curr_epoch))
