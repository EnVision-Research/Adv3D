...
def main():
    ...
    trans_lcs = []
    # trans_lcs.append('/home/leheng.li/mmlab/arf_package/mmdetection3d/adv_fcos3d/lc_folder/lc_0004.pth')
    # trans_lcs.append('/home/leheng.li/mmlab/arf_package/mmdetection3d/adv_pgd/lc_folder/lc_0004.pth')
    # trans_lcs.append('/home/leheng.li/adv3d/nets/detr3d/lc_folder/lc_0004.pth')
    # trans_lcs.append('/home/leheng.li/adv3d/nets/BEVDet/atk_exp/lc_folder/lc_0004.pth')
    # trans_lcs.append('/home/leheng.li/adv3d/nets/BEVFormer/lc_folder/lc_0004.pth')


    trans_lcs.append('/home/leheng.li/adv3d/nets/BEVDet/atk_exp_nocbgs/lc_folder/lc_0001.pth')




    for curr_lc in trans_lcs:
        patch_net.module.lc_list[0] = torch.load(curr_lc)
        ...
        for i, data in enumerate(data_loader):
            with torch.no_grad():
                ...
                # if i == 0:
                #     utils.save_image(img_edit.reshape((-1, 3, 256, 704))[:, [2,1,0], ...] / 255, f'atk_exp/vis_folder/vals_{curr_epoch}.jpg')
        ...
        if rank == 0:
            ...
            if args.eval:
                ...
                # curr_det = curr_lc.split('/')[-3]
                # df = open(f'trans_res/{curr_det}.txt', 'a')
                # df.write(str(eval_result))
                # df.close()
