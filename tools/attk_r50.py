...
def main():
    ...
    for curr_epoch in range(6):
        ...
        for i, data in enumerate(tqdm.tqdm(data_loader_train)):
            ...
            if i == 0:
                utils.save_image(img_edit.reshape((-1, 3, 256, 704))[:, [2,1,0], ...] / 255, f'atk_exp_nocbgs/adv_train_robuss_eval/vis_folder/trains_{curr_epoch}.jpg')
        ...
        torch.save(patch_net.module.lc_list[0], 'atk_exp_nocbgs/adv_train_robuss_eval/lc_folder/lc_%04d.pth' % curr_epoch)
        ...
        for i, data in enumerate(data_loader):
            with torch.no_grad():
                ...
                if i == 0:
                    utils.save_image(img_edit.reshape((-1, 3, 256, 704))[:, [2,1,0], ...] / 255, f'atk_exp_nocbgs/adv_train_robuss_eval/vis_folder/vals_{curr_epoch}.jpg')
