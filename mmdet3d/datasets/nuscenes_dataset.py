...
class NuScenesDataset(Custom3DDataset):
    ...
    def _format_bbox_single(self, results, jsonfile_prefix=None, other_info=None):
        """Convert the results to the standard format.
    ...
    def format_results_single(self, results, jsonfile_prefix=None, other_info=None):
        ...
        if not ('pts_bbox' in results[0] or 'img_bbox' in results[0]):
            result_files = self._format_bbox_single(results, jsonfile_prefix, other_info)
        else:
            ...
            for name in results[0]:
                ...
                result_files.update(
                    {name: self._format_bbox_single(results_, tmp_file_, other_info)})
